(define (problem sqa) (:domain courses)
    ...
    ; TODO: Add grades, and allocate teams
    (:init
        (= (duration) 0)

        (takes-course emily english national-four)
        (takes-course emily drama higher)
        ...
        (takes-course james art-design higher)
        (takes-course james music national-five)
        ...
        (takes-course sophia music-tech national-five)
        (takes-course sophia maths national-four)
        (takes-course sophia italian national-five)
        (takes-course sophia modern-studies national-four)

        (takes-course ben esol national-four)
        (takes-course ben drama higher)
        (takes-course ben music national-five)
        (takes-course ben numeracy national-four)
        (takes-course ben latin national-five)
        (takes-course ben rmps national-four)

        (takes-course olivia esol national-four)
        (takes-course olivia art-design higher)
        ...
        (takes-course daniel english national-four)
        (takes-course daniel dance higher)
        (takes-course daniel music national-five)
        (takes-course daniel numeracy national-four)
        (takes-course daniel mandarin national-five)
        (takes-course daniel politics national-four)

        (takes-course mia esol national-four)
        (takes-course mia drama higher)
        (takes-course mia music-tech national-five)
        (takes-course mia phys-ed national-four)
        (takes-course mia spanish national-five)
        (takes-course mia admin-it national-four)

        (takes-course alex english national-four)
        (takes-course alex art-design higher)
        (takes-course alex music national-five)
        (takes-course alex phys-ed national-four)
        (takes-course alex latin national-five)
        (takes-course alex business-management national-four)

        (takes-course charlotte english national-four)
        (takes-course charlotte art-design higher)
        (takes-course charlotte music national-five)
        (takes-course charlotte textiles national-four)
        (takes-course charlotte gaelic national-five)
        (takes-course charlotte comp-sci national-four)

        (takes-course will esol national-four)
        (takes-course will drama higher)
        (takes-course will music national-five)
        (takes-course will textiles national-four)
        (takes-course will german national-five)
        (takes-course will design-manufacture national-four)

        (takes-course ava english national-four)
        (takes-course ava dance higher)
        (takes-course ava maths national-five)
        (takes-course ava textiles national-four)
        (takes-course ava mandarin national-five)
        (takes-course ava graph-comm national-four)

        (takes-course sam esol national-four)
        (takes-course sam drama higher)
        (takes-course sam music-tech national-five)
        (takes-course sam textiles national-four)
        (takes-course sam spanish national-five)
        (takes-course sam practical-woodwork national-four)
    )
