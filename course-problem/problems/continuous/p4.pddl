(define (problem p4) (:domain courses)
	...
	(:init
		...
		(= (week jack textiles higher) 0)
		(= (week jack french national-five) 0)
		(= (week jack chemistry higher) 0)
		(= (week jack physics national-four) 0)
		(= (week jack admin-it year-two) 0)

		(= (unit jack textiles higher) 0)
		(= (unit jack french national-five) 0)
		(= (unit jack chemistry higher) 0)
		(= (unit jack physics national-four) 0)
		(= (unit jack admin-it year-two) 0)

		(= (extra-curricular jack textiles higher) 0)
		(= (extra-curricular jack french national-five) 0)
		(= (extra-curricular jack chemistry higher) 0)
		(= (extra-curricular jack physics national-four) 0)
		(= (extra-curricular jack admin-it year-two) 0)
		(= (uses-strategy jack teamwork) 0)
		...
		(= (week william latin national-five) 0)
		(= (week william cantonese higher) 0)
		(= (week william dance higher) 0)
		(= (week william geography year-three) 0)
		(= (week william english higher) 0)

		(= (unit william latin national-five) 0)
		(= (unit william cantonese higher) 0)
		(= (unit william dance higher) 0)
		(= (unit william geography year-three) 0)
		(= (unit william english higher) 0)

		(= (extra-curricular william latin national-five) 0)
		(= (extra-curricular william cantonese higher) 0)
		(= (extra-curricular william dance higher) 0)
		(= (extra-curricular william geography year-three) 0)
		(= (extra-curricular william english higher) 0)
		(= (uses-strategy william gamification) 0)
		...
		(= (week alexander practical-woodwork year-one) 0)
		(= (week alexander drama national-four) 0)
		(= (week alexander biology year-one) 0)
		(= (week alexander business-management adv-higher) 0)
		(= (week alexander chemistry adv-higher) 0)

		(= (unit alexander practical-woodwork year-one) 0)
		(= (unit alexander drama national-four) 0)
		(= (unit alexander biology year-one) 0)
		(= (unit alexander business-management adv-higher) 0)
		(= (unit alexander chemistry adv-higher) 0)

		(= (extra-curricular alexander practical-woodwork year-one) 0)
		(= (extra-curricular alexander drama national-four) 0)
		(= (extra-curricular alexander biology year-one) 0)
		(= (extra-curricular alexander business-management adv-higher) 0)
		(= (extra-curricular alexander chemistry adv-higher) 0)
		(= (uses-strategy alexander student-led-class) 0)
		...
		(= (week aurora music higher) 0)
		(= (week aurora urdu higher) 0)
		(= (week aurora latin year-one) 0)
		(= (week aurora textiles year-one) 0)
		(= (week aurora chemistry year-two) 0)

		(= (unit aurora music higher) 0)
		(= (unit aurora urdu higher) 0)
		(= (unit aurora latin year-one) 0)
		(= (unit aurora textiles year-one) 0)
		(= (unit aurora chemistry year-two) 0)

		(= (extra-curricular aurora music higher) 0)
		(= (extra-curricular aurora urdu higher) 0)
		(= (extra-curricular aurora latin year-one) 0)
		(= (extra-curricular aurora textiles year-one) 0)
		(= (extra-curricular aurora chemistry year-two) 0)
		...
		(= (week pippa cantonese adv-higher) 0)
		(= (week pippa history national-four) 0)
		(= (week pippa drama year-two) 0)
		(= (week pippa mandarin adv-higher) 0)
		(= (week pippa maths adv-higher) 0)

		(= (unit pippa cantonese adv-higher) 0)
		(= (unit pippa history national-four) 0)
		(= (unit pippa drama year-two) 0)
		(= (unit pippa mandarin adv-higher) 0)
		(= (unit pippa maths adv-higher) 0)

		(= (extra-curricular pippa cantonese adv-higher) 0)
		(= (extra-curricular pippa history national-four) 0)
		(= (extra-curricular pippa drama year-two) 0)
		(= (extra-curricular pippa mandarin adv-higher) 0)
		(= (extra-curricular pippa maths adv-higher) 0)
		(= (uses-strategy pippa flex-seating) 0)
