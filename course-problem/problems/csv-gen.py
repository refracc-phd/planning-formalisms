...
# Set the directories
continuous_directory_path = "/Users/refracc/Documents/PhD/planning-formalisms/course-problem/problems/continuous"
discrete_directory_path = "/Users/refracc/Documents/PhD/planning-formalisms/course-problem/problems/discrete"
...
with open(output_csv, 'w', newline='') as csvfile:
    fieldnames = ['Type', 'File Name', 'Plan Length', 'Metric (Search)', 'Planning Time (msec)',
                  'Heuristic Time (msec)', 'Search Time (msec)', 'Expanded Nodes',
                  'States Evaluated', 'Duplicates Detected']
